...
**E · PAYWALL / PRICING — v1 MODEL CONCRETE.** `PaywallView` is **LIVE in Release/TestFlight**,
gating premium instruments at point of use; it was only **suppressed in DEBUG** (why it "vanished"
in dev) — never removed. **v1 model: FREE = compass instrument + a set of emojis; LOCKED = other
animations/instruments** ("monetize at point of use"). Commercial setup (Paid Apps Agreement,
banking/tax, IAP products) is a **later launch step, not done.** (See LAUNCH / MONETIZATION.)
...
### ⭐ LAUNCH / MONETIZATION STRATEGY (v1 model CONCRETE; propagation specifics = later)
**⭐ v1 MODEL — CONCRETE (2026-06-22):** **FREE = the compass instrument + a set of emojis.
LOCKED (paywall) = the other animations/instruments.** "Monetize at point of use, not at entry."
**The paywall (`PaywallView`) is LIVE in Release/TestFlight builds** and gates premium instruments
at point of use — it was only **suppressed in DEBUG builds** (why it seemed to "vanish" during dev
testing), **never removed.** Commercial setup (Paid Apps Agreement, banking/tax, IAP products) is a
**later launch step — NOT done yet.** A **TESTER-UNLOCK** (internal testers see premium unlocked in
Release while real users stay gated) is a PLANNED next build. _The free-vs-paid SHAPE is locked; the
generosity/propagation mechanics below remain the open "when/how much" decision._
