...
`624b044` → `bd285d8` → `380d374` → `68de96d` → `e6e0608` → `5cf1d47` (HEAD).)
...
- **`5cf1d47`** — bucket per-item **DELETE**: `PingManager.removeFromHistory(id:)` (keyed on
  ...
  _(reports/bucket_delete_build.md)_
  ...
  > bucket-delete shipped, device-test PENDING.
