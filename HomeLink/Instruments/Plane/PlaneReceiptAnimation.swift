...
enum PlaneReceiptAnimation {
  /// Full-screen receipt duration (seconds). Source of truth:
  /// InstrumentBoundaries.Receipt.plane.
  static let duration: Double = InstrumentBoundaries.Receipt.plane

  /// Sound file + duration for the receipt phase.
  static let soundFile: String = PlaneSounds.receiptFile
  static let soundDuration: Double = PlaneSounds.receiptDuration
