...
// "plane" branch inside SenderAnimationView (the shared
...
enum PlaneSendAnimation {
  /// Full-screen send duration (seconds). Source of truth:
  /// InstrumentBoundaries.Send.plane.
  ...
  static let soundDuration: Double = PlaneSounds.sendDuration
