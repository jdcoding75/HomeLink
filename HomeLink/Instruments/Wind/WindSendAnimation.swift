...
// "wind" branch inside SenderAnimationView (the shared
...
enum WindSendAnimation {
  /// Full-screen send duration (seconds). Source of truth:
  /// InstrumentBoundaries.Send.wind.
  static let duration: Double = InstrumentBoundaries.Send.wind
