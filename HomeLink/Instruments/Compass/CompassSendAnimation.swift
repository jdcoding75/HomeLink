...
// "compass" branch inside SenderAnimationView (the shared
...
enum CompassSendAnimation {
  /// Full-screen send duration (seconds). Source of truth:
  /// InstrumentBoundaries.Send.compass.
  static let duration: Double = InstrumentBoundaries.Send.compass

  /// Sound file + duration for the send phase.
  static let soundFile: String = CompassSounds.sendFile
  static let soundDuration: Double = CompassSounds.sendDuration
