...
// "wand" branch inside SenderAnimationView (the shared
...
enum WandSendAnimation {
  /// Full-screen send duration (seconds). Source of truth:
  /// InstrumentBoundaries.Send.wand.
  static let duration: Double = InstrumentBoundaries.Send.wand

  /// Sound file + duration for the send phase.
  static let soundFile: String = WandSounds.sendFile
  static let soundDuration: Double = WandSounds.sendDuration
