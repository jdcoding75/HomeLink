...
enum WandReceiptAnimation {
  /// Full-screen receipt duration (seconds). Source of truth:
  /// InstrumentBoundaries.Receipt.wand.
  static let duration: Double = InstrumentBoundaries.Receipt.wand

  /// Sound file + duration for the receipt phase.
  static let soundFile: String = WandSounds.receiptFile
  static let soundDuration: Double = WandSounds.receiptDuration
