...
enum RocketReceiptAnimation {
  /// Full-screen receipt duration (seconds). Source of truth:
  /// InstrumentBoundaries.Receipt.rocket.
  static let duration: Double = InstrumentBoundaries.Receipt.rocket

  /// Sound file + duration for the receipt phase.
  static let soundFile: String = RocketSounds.receiptFile
  static let soundDuration: Double = RocketSounds.receiptDuration
