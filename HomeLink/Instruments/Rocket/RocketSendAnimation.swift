...
// "rocket" branch inside SenderAnimationView (the shared
...
enum RocketSendAnimation {
  /// Full-screen send duration (seconds). Source of truth:
  /// InstrumentBoundaries.Send.rocket.
  static let duration: Double = InstrumentBoundaries.Send.rocket

  /// Sound file + duration for the send phase.
  static let soundFile: String = RocketSounds.sendFile
  static let soundDuration: Double = RocketSounds.sendDuration
