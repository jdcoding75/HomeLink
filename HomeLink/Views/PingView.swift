...
// [pairing-retire extraction-prep] CreateThoughtSheet + LeopardGeckoView (both LIVE,
// used outside PingView) MOVED VERBATIM to their own files —
// CreateThoughtSheet.swift / LeopardGeckoView.swift — so they no longer share a file
// with the (dead, unmounted) PingView struct above. PingView itself is retired next.
