...
// [9b · B1] PostOnboardConnectPrompt (pairing-era post-onboarding nudge; held the
...
// [9b · B1] PairRequestView (pairing-era accept sheet; held the dead accept →
// redeem/addFromInvite/lookupInvite path) — HARD-DELETED (was #if false). See
// reports/ninebee_b1_deadviews_build.md. (The `PairRequest` model above is left as
// a B-leftover — orphaned but harmless; not a view.)
