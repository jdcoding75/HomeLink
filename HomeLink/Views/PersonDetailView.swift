    ...
    private var connectionCard: some View {
        if isConnected {
            ...
            VStack(spacing: 14) {
                ...
                // [9b · B1] pairing-era "connect with [name]" CTA + invite/iMessage/
                // code-entry UI HARD-DELETED (was #if false, #5). Not-yet-linked shows
                // only this calm status; sending happens via the link path on the compass.
            }
            .padding(16)
